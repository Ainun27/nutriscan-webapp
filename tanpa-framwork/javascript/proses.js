...
function showErrorMessage(message) {
    ...
    setTimeout(() => {
        ...
        window.location.href = "dashboard.html";  // Atau bisa diganti dengan aksi lain yang diinginkan
...
// Proses saat tombol "Lanjut ke Input Manual" ditekan
goToManualInput.addEventListener('click', () => {
